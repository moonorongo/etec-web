      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center px-4">
        <div className="max-w-md space-y-8 mx-auto ">
          ...
          <p className="!leading-loose text-sm md:text-base">
            ...
            <strong>&quot;La Asociación Civil Unión 20 de Agosto&quot;</strong>,
          ...
          <p className="!leading-loose text-sm md:text-base">
            ...
            calculadoras, este lugar ofrece una muestra permanente y actividades
            como muestras itinerantes, charlas temáticas y encuentros de
            comunidades relacionadas con la informática.
          </p>
          <p className="!leading-loose text-sm md:text-base">
            Promovemos la sustentabilidad y el consumo responsable,
            concientizando sobre la obsolescencia tecnológica y su impacto en el
            medio ambiente.
          </p>
        </div>
        <ImagesGrid />
